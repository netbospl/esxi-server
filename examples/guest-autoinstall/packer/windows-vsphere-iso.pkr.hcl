...
// Keep a manual fallback documented: create the VM by hand and attach answer media if API automation is unavailable.
...
source "vsphere-iso" "windows" {
  ...
  winrm_password = "REPLACE_WITH_WINRM_PASSWORD"
  winrm_timeout  = "6h"
